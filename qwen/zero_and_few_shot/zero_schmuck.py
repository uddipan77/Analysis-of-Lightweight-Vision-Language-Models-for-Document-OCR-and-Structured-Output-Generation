...
class SchmuckOCRProcessor:
    ...
    def process_image_zero_shot(self, image_path: str) -> str:
        ...
        try:
            # Create message with only the test image and instruction
            messages = [
                {
                    "role": "user",
                    "content": [
...
def save_predictions_with_timestamp(predictions, test_data, all_cer_scores, base_dir="/home/vault/iwi5/iwi5298h/models_image_text/qwen/shots_schmuck"):
    ...
    if all_cer_scores:
        ...
        # Print results
        print("\n" + "="*60)
        print("QWEN2.5-VL ZERO-SHOT CER EVALUATION RESULTS")
...
def main():
    ...
    # Load test data
    print("="*60)
    print("QWEN2.5-VL ZERO-SHOT JEWELRY CATALOG OCR PROCESSING")
    print("="*60)
    print("\nLoading test data...")
