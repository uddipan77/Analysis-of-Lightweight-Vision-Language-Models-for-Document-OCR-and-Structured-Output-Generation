...
class StaircaseOCRFinetune:
    def __init__(
        ...
        self.model, self.tokenizer = FastVisionModel.from_pretrained(
            model_path,
            max_seq_length=1024,    # UPDATED/CONFIRMED: max_seq_length = 1024
            dtype=None,
            load_in_4bit=True,
            trust_remote_code=True,
        )

        # LoRA: UPDATED hyperparameters
        self.model = FastVisionModel.get_peft_model(
            self.model,
            r=8,  # UPDATED: lora_r = 8
            target_modules=[
                "q_proj", "k_proj", "v_proj", "o_proj",
                "gate_proj", "up_proj", "down_proj",
            ],
            lora_alpha=128,  # UPDATED: lora_alpha = 128
            lora_dropout=0.033110475982980114,  # UPDATED: lora_dropout
            bias="none",
        ...
        print("Model loaded successfully with LoRA (r=8, no offload)!")
    ...
    def train_model(
        ...
        num_epochs: int = 20,
        batch_size: int = 1,
        learning_rate: float = 4.6092417614001694e-05,  # UPDATED: learning_rate
    ):
        ...
        trainer = SFTTrainer(
            ...
            args=SFTConfig(
                ...
                gradient_accumulation_steps=4,  # UPDATED/CONFIRMED: grad_accum = 4
                warmup_steps=50,
                ...
                weight_decay=0.04450148444751451,  # UPDATED: weight_decay
                lr_scheduler_type="cosine",
                warmup_ratio=0.031441561343338295,  # UPDATED: warmup_ratio
                optim="adamw_8bit",
                ...
                max_seq_length=1024,  # UPDATED/CONFIRMED
    ...
    def save_cer_results(
        ...
        with open(cer_file, "w", encoding="utf-8") as f:
            ...
            f.write("- LoRA rank: 8\n")  # UPDATED
            f.write("- LoRA alpha: 128\n")  # UPDATED
            f.write("- LoRA dropout: 0.033110475982980114\n")  # UPDATED
            f.write("- Weight decay: 0.04450148444751451\n")  # UPDATED
...
def main():
    ...
    config = {
        ...
        "num_epochs": 20,
        "batch_size": 1,
        "learning_rate": 4.6092417614001694e-05,  # UPDATED
        "augment_factor": 1,
    }
