...
class InventoryOCRProcessor:
    ...
    def process_image_zero_shot(self, image_path: str) -> str:
        ...
        # Create prompt for German historical inventory document OCR (NEW structure)
        prompt = """Extract the inventory information from this German historical document image as a JSON object with the following fields:
...
Return ONLY a valid JSON object. Use empty strings "" for missing fields."""
        ...
        inputs = self.processor(text=[text], images=[image_path], padding=True, return_tensors="pt")
...
def save_predictions_with_timestamp(predictions, test_data, all_cer_scores, base_dir="/home/vault/iwi5/iwi5298h/models_image_text/nanonets/shots_inven"):
...
def main():
    """Main function to process inventory images with zero-shot learning."""
    ...
    # Load test data
    print("="*60)
    print("NANONETS-OCR-S ZERO-SHOT INVENTORY OCR PROCESSING")
    print("="*60)
    print("\nLoading test data...")
