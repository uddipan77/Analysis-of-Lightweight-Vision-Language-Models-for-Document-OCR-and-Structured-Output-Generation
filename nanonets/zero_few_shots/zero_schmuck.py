...
class SchmuckOCRProcessor:
    ...
    def process_image_zero_shot(self, image_path: str) -> str:
        ...
        # Create detailed prompt for German jewelry catalog
        prompt = """Extract the jewelry catalog information from this German museum document as a JSON object with the following fields:
...
Return ONLY a valid JSON object. Use empty strings "" for missing fields."""
        ...
        messages = [
            {"role": "system", "content": "You are a helpful assistant specialized in extracting structured data from museum catalog documentation."},
            {"role": "user", "content": [
                {"type": "image"},
...
def save_predictions_with_timestamp(predictions, test_data, all_cer_scores, base_dir="/home/vault/iwi5/iwi5298h/models_image_text/nanonets/shots_schmuck"):
...
def main():
    """Main function to process jewelry catalog images with zero-shot learning."""
    ...
    # Load test data
    print("="*60)
    print("NANONETS-OCR-S ZERO-SHOT JEWELRY CATALOG OCR PROCESSING")
    print("="*60)
    print("\nLoading test data...")
