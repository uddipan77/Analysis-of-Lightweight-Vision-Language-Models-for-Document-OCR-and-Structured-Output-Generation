...
#SBATCH --job-name=inventory_updated_pre
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/gemma/%j/inventory_updated_pre.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/gemma/%j/inventory_updated_pre.err
...
python3 inventory_updated_pre.py
