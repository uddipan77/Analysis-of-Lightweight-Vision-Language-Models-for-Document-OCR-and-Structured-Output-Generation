...
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/F1_inven/%j/layoutlmv3_T5_code1_inventory.out# Standard output log file
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/F1_inven/%j/layoutlmv3_T5_code1_inventory.err  # Standard error log file

# ===============================
# Environment Configuration
# ===============================
# Create log directory for this job
LOG_DIR="/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/F1_inven/${SLURM_JOB_ID}"
mkdir -p "$LOG_DIR"
...
# ===============================
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/F1_score/

# ===============================
# Execute the Python Script
# ===============================

python3 code1_updated.py
