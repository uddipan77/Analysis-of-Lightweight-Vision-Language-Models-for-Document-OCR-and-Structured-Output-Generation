...
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/GOT/%j/convert.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/GOT/%j/convert.err
...
# Run training
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/GOT
python3 convert.py
echo "GOT conversion completed at: $(date)"
