...
#SBATCH --time=00:10:00                 # Maximum runtime of 24 hours
#SBATCH --export=NONE                   # Do not export current environment variables
#SBATCH --job-name=inven                  # Job name
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/APCER_inven/%j/trocr_inven_with_cer_and_apcer.out# Standard output log file
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/APCER_inven/%j/trocr_inven_with_cer_and_apcer.err  # Standard error log file

# ===============================
# Environment Configuration
# ===============================
# Create log directory for this job
LOG_DIR="/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/APCER_inven/${SLURM_JOB_ID}"
mkdir -p "$LOG_DIR"
...
# ===============================
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/AP_CER/

# ===============================
# Execute the Python Script
# ===============================

python3 code_cer_ap.py
