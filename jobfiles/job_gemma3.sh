...
#SBATCH --job-name=inventory_updated_ms
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/gemma/%j/inventory_updated_ms.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/gemma/%j/inventory_updated_ms.err
...
# Run training
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/gemma3/multi/
python3 inventory_updated_ms.py
