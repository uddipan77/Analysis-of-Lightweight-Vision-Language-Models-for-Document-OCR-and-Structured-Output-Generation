...
#SBATCH --time=15:00:00                 # Maximum runtime of 24 hours
#SBATCH --export=NONE                   # Do not export current environment variables
#SBATCH --job-name=T5_Lay_simple                 # Job name
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/T5_Layoutlmv3/%j/schmuck.out # Standard output log file
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/T5_Layoutlmv3/%j/schmuck.err   # Standard error log file
