...
#SBATCH --time=12:00:00                 # Maximum runtime of 24 hours
#SBATCH --export=NONE                   # Do not export current environment variables
#SBATCH --job-name=layout_stair                  # Job name
# Use SLURM_JOB_ID for log folder - %j expands to job ID
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/T5_Layoutlmv3/%j/code1.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/T5_Layoutlmv3/%j/code1.err
...
echo "==================================="
echo "GOT-OCR2 Job Configuration:"
echo "==================================="
...
# ===============================
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/T5_LayoutLMV3/extras
