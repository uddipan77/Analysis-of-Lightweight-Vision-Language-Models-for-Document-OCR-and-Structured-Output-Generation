...
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/docling/%j/stair.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/docling/%j/stair.err
...
echo "Script: /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/docling/stair.py"
echo "Job started at: $(date)"
echo "=========================================="
 
# Navigate to script directory and run
cd /home/hpc/iwi5/iwi5298h/Uddipan-Thesis/docling/
python3 stair.py
