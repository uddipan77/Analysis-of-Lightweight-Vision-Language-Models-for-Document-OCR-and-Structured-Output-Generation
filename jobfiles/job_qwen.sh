...
#SBATCH --export=NONE
#SBATCH --job-name=inventory_updated_preprocess
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/QWEN/%j/inventory_updated_preprocess.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/QWEN/%j/inventory_updated_preprocess.err
...
python3 inventory_updated_preprocess.py