...
#SBATCH --job-name=new_few_inven2
#SBATCH --output=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/nano/%j/new_few_inven2.out
#SBATCH --error=/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/nano/%j/new_few_inven2.err
# Create log directory

LOG_DIR="/home/hpc/iwi5/iwi5298h/Uddipan-Thesis/logs/nano/${SLURM_JOB_ID}"
mkdir -p "$LOG_DIR"
