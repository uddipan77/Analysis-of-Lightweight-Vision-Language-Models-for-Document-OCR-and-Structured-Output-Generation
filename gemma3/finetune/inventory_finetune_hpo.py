...
class InventoryGemma3Finetune:
    def __init__(self, model_path: str):
        ...
        # ✅ Updated LoRA config (from provided Params)
        self.model = FastVisionModel.get_peft_model(
            ...
            lora_alpha=128,
            lora_dropout=0.1266202914546536,
            bias="none",
    ...
    def train_model(
        ...
        trainer = SFTTrainer(
            ...
            args=SFTConfig(
                ...
                warmup_steps=100,
                num_train_epochs=7,
                learning_rate=6.395782863492867e-05,
                logging_steps=5,
                eval_strategy="epoch",
                save_strategy="epoch",
                save_total_limit=3,
                max_grad_norm=1.8456653899288655,
                ...
                weight_decay=0.05801030194508061,
                lr_scheduler_type="cosine",
                warmup_ratio=0.14519113577404788,
