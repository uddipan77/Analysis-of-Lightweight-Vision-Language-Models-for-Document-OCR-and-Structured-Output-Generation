...
CONFIG = {
    ...
    "num_epochs": 10,
    "stage1_epochs": 2,  # warm-up epochs (reduced from 3 — less exposure to elevated LR)
    "batch_size": 1,
    ...
    def on_evaluate(self, args, state, control, model, metrics=None, **kwargs):
        ...
        for i, val_item in enumerate(self.val_data):
            ...
            try:
                ...
                print(f"\n   ⚠️  Validation error on {val_item['image_name']}: {e}")
                predictions.append("")
...
def main():
    ...
    print(f"   • Training epochs: {CONFIG['num_epochs']} (Stage1: {CONFIG['stage1_epochs']}, Stage2: {CONFIG['num_epochs'] - CONFIG['stage1_epochs']})")
    ...
    # ==================================================================
    # STAGE 1 – Warm-up training (no eval, higher LR)
    # ==================================================================
    print("\n" + "=" * 80)
    ...
    stage1_args = TrainingArguments(
        ...
        learning_rate=CONFIG["learning_rate"] * 1.5,  # slightly higher LR for warm-up (was 3x, too aggressive)
        weight_decay=CONFIG["weight_decay"],
        max_grad_norm=CONFIG["max_grad_norm"],
        warmup_ratio=0.15,
        lr_scheduler_type="linear",  # linear keeps signal throughout; cosine crashed to ~0
        logging_steps=10,
        save_strategy="no",
        eval_strategy="no",
    ...
    stage2_epochs = max(1, CONFIG["num_epochs"] - CONFIG["stage1_epochs"])
    print(f"Total epochs: {CONFIG['num_epochs']} -> Stage1: {CONFIG['stage1_epochs']}, Stage2: {stage2_epochs}")

    # CER callback for Stage 2
    ...
    stage2_args = TrainingArguments(
        ...
        weight_decay=CONFIG["weight_decay"],
        max_grad_norm=CONFIG["max_grad_norm"],
        warmup_ratio=0.03,  # model already warm from Stage 1, minimal warmup
    ...
    print(f"\n{'='*80}")
    print("📊 FINAL TEST RESULTS - INVENTORY DATASET")
    print(f"{'='*80}")
