...
# ============================================================================
# ADDED: 4-step preprocessing (on-the-fly, no saving)  [SAME AS CODE 1]
# ============================================================================
...
CONFIG = {
    ...
    # UPDATED: base output dir + timestamp subfolder (SAME IDEA AS STAIRCASE)
    "output_dir": os.path.join(
        "/home/vault/iwi5/iwi5298h/models_image_text/phi/schmuck/finetune",
